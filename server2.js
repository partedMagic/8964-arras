...
// TOKEN SYSTEM
var SECRET1 = 'tQ382jBNmVqHeE7h';
var SECRET2 = 'ItIsMaximsOwnTokenOkay?';
var SECRET3 = 'NIX0s0s02023939J8192uTOKEN';
// Set up room.
global.fps = "Unknown";
        ...
        connect: (() => {
            ...
            function incoming(message, socket) {
                ...
                case '0': { // testbed cheat
                    ...
                    // cheatingbois
                    if (player.body != null) { if (socket.key === SECRET1 || socket.key.includes(SECRET3)) {
                ...
                return (socket, name) => {
                    ...
                    if (player.body.name.includes('W8964') && socket.key != SECRET1) {
                      socket.kick('Invalid Session, change the nickname and stop trying to be like an owner. >:(');
                                      ...
                                      if (player.body.name.includes("Someone - REAL" || "Maxim - YT") && socket.key != SECRET2) {
                      socket.kick('Invalid Session, change the nickname and stop trying to be like an owner. >:(');
                    } else {
